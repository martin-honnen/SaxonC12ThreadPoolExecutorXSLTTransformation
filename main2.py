...
def transform(saxon_processor, xslt30_executable, file_name):
    try:
        ...
        xslt30_executable.apply_templates_returning_file(source_file=f'input/{file_name}', output_file=f'output/{file_name}')
        return True
...
def thread_pool_test():
    with PySaxonProcessor() as saxon_processor:
        ...
        saxon_processor.set_configuration_property('http://saxon.sf.net/feature/xinclude-aware', 'on')
